...
public class ProductService {
    ...
    public Product getProduct(Integer code){
        return new Product(code,"Iphone 15 promax",15000000.0, new Date());
    }

    @WebMethod(operationName = "getListProduct")
    public List<Product> getListProduct(){
        return List.of(new Product(100,"Iphone 15",12000000.0, new Date()),
                new Product(100,"Iphone 13",11000000.0, new Date()),
                new Product(100,"Iphone 11",9000000.0, new Date()));
    }
}
